...
class ConnectionResNet(nn.Module):
    def __init__(self, block, layers, nf=64, inplanes=0, zero_init_residual=True, dataset='cifar', start_class=0,
                 remove_last_relu=False):
        super(ConnectionResNet, self).__init__()
        self.remove_last_relu = remove_last_relu
        self.nf = nf
